...
#Top Margin Filtering
    ...
    for x in left:
        left_diff.append(x[1] - y_plot2)
    for x in right: 
        right_diff.append(x[1] - y_plot2)
        
    print(left_diff)
    print(right_diff, "\n")
    
    left_filtered = remove_outliers(left_diff)
    right_filtered = remove_outliers(right_diff)
